...
class ShoowroomController extends Controller
{
    ...
    public function getshowroomcarcompany(Request $request)
    {
        try {
            $shoowroom = Showroom::select('showroom.car_id', 'showroom.company_id', 'showroom.step1', 'showroom.step2', 'showroom.step3', 'showroom.step4', 'showroom.step5', 'showroom.car_name', 'showroom.car_description', 'showroom.car_image_url', 'showroom.isTestdrive')
        ...
        try {
            ...
            if ($result) {
                $responseData = [
                    "result" => $result,
                    "success" => 1,
                    "message" => "Galeriye resim eklendi",
                ];
            } else {
                $responseData = [
                    "success" => 0,
                    "message" => "Galeriye resim eklenemedi, lütfen tekrar deneyiniz",
                ];
            }
        } catch (\Exception $e) {
            $responseData = [
