                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="insurance_end_date"
                                        name="insurance_end_date" data-provider="flatpickr">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="dropzone" id="poldiv">
                                <div class="fallback">
                                    <input name="file" type="file" id="insurance_policy_url"
                                        name="insurance_policy_url">
                                </div>
