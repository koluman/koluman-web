            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <button type="button" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @break
                        @case('tr')
                        <img src="{{ URL::asset('build/images/flags/tr.svg') }}" class="rounded" alt="Header Language" height="20">
                        @break
                        @default
                        <img src="{{ URL::asset('build/images/flags/tr.svg') }}" class="rounded" alt="Header Language" height="20">
                        @endswitch
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                          <a href="{{ url('index/tr') }}" class="dropdown-item notify-item language py-2" data-lang="tr" title="Türkçe">
                            <img src="{{ URL::asset('build/images/flags/tr.svg') }}" alt="user-image" class="me-2 rounded" height="20">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->backuser_image_url != ''){{ URL::asset('images/' . Auth::user()->user_image_url) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }}@endif" alt="Header Avatar">
