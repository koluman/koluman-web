                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <button type="button"
                        ...
                        @switch(Session::get('lang'))
                            ...
                            @case('tr')
                                <img src="{{ URL::asset('build/images/flags/tr.svg') }}" class="rounded"
                                    alt="Header Language" height="20">
                            @break
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <a href="{{ url('index/tr') }}" class="dropdown-item notify-item language py-2"
                            data-lang="tr" title="Türkçe">
                            <img src="{{ URL::asset('build/images/flags/tr.svg') }}" alt="user-image"
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light text-body fs-13"> 4 Yeni</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 lh-base">İçerik <b>deneme</b> ddgdfgfdgfdg
                                                     <span class="text-secondary">sdsdsd</span> sdfsdfdsfsdf!
                                                    </h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> 3 gün önce</span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-1 fs-13 fw-semibold">İçerik</h6>
                                                </a>
                                                <div class="fs-13 text-muted">
                                                    <p class="mb-1">fgdfgdfgdfgfdgdfdgdfgdfgdfgdfg🔔.</p>
                                                </div>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> 48 dakika önce</span>
                                                </p>
                                            </div>
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <button type="button"
                                            ...
                                            Tümünü GÖr<i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-1 fs-13 fw-semibold">Kullanıcı adı</h6>
                                                </a>
                                                <div class="fs-13 text-muted">
                                                    <p class="mb-1">dssdfdsfsdfdsfdsfsdf.</p>
                                                </div>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> 30 dakika önce</span>
                                                </p>
                                            </div>
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-1 fs-13 fw-semibold">Kullanıcı 2</h6>
                                                </a>
                                                <div class="fs-13 text-muted">
                                                    <p class="mb-1">asdsadasdasdsadad asfdafadf assf🔔.</p>
                                                </div>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <button type="button"
                                            class="btn btn-soft-success waves-effect waves-light">Tümünü Gör <i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::guard('web')->user()->backuser_name }}</span>
                               <span
