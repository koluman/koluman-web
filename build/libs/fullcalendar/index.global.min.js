...
var FullCalendar = function (e) {
    ...
    function Rt(e, t) {
        if (e === t) return !0;
        for (let n in e)
            if (Et.call(e, n) && !(n in t)) return !1;
        for (let n in t)
            if (Et.call(t, n) && e[n] !== t[n]) return !1;
        return !0
    }
    const xt = /^on[A-Z]/;
    ...
    function tr(e, t = ht(0)) {
        ...
        return e.start && (n = Lt(e.start), r && r <= n && (r = Pt(n, 1))), {
            start: n,
            end: r
        }
    }
    ...
    function ni(e, t) {
        ...
        var r, i;
        return Object.assign(n, (r = e, i = t.dateEnv, Object.assign(Object.assign({}, Mi(r.range, i, r.allDay)), {
            allDay: r.allDay
        }))), n
    }
    ...
    class li {
        ...
        setProp(e, t) {
            ...
            else if ("id" === e) t = Gn[e](t), this.mutate({
                standardProps: {
                    publicId: t
                }
            });
            else if (e in Gn) t = Gn[e](t), this.mutate({
                standardProps: {
                    [e]: t
                }
            });
        ...
        formatRange(e) {
            let {
                dateEnv: t
            } = this._context, n = this._instance, r = yn(e);
    ...
    function _i(e, t, n) {
        let r = function (e, t) {
                let {
                    refined: n,
                    extra: r
                } = _n(e, xi), i = n.start ? t.createMarkerMeta(n.start) : null, s = n.end ? t.createMarkerMeta(n.end) : null, {
                    allDay: o
                } = n;
    ...
    class ji {
        ...
        insertEntryAt(e, t) {
            let {
                entriesByLevel: n,
                levelCoords: r
            } = this; - 1 === t.lateral ? (Fi(r, t.level, t.levelCoord), Fi(n, t.level, [e])) : Fi(n[t.level], t.lateral, e), this.stackCnts[Ui(e)] = t.stackCnt
        }
        findInsertion(e) {
            let {
                levelCoords: t,
    ...
    class cs extends Xr {
        render() {
            let {
                ...
                date: s,
                dateProfile: o
            } = i, a = Sr(s, i.todayRange, null, o), l = [es].concat(Ar(a, n)), c = e.format(s, i.dayHeaderFormat), d = !a.isDisabled && i.colCnt > 1 ? Cr(this.context, s) : {}, u = Object.assign(Object.assign(Object.assign({
                date: e.toDate(s),
                view: r
            }, i.extraRenderProps), {
                text: c
    ...
    class hs extends D {
        ...
        computeTiming() {
            let {
                props: e,
                context: t
            } = this, n = Ht(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs), r = t.dateEnv.startOf(n, e.unit), i = t.dateEnv.add(r, ht(1, e.unit)), s = i.valueOf() - n.valueOf();
    ...
    class ms {
        ...
        getDateDayIndex(e) {
            let {
                indices: t
            } = this, n = Math.floor(jt(this.dates[0], e));
    ...
    function Ds(e, t, n) {
        let {
            defs: r
        } = e, i = Dt(e.instances, e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    function Cs(e, t, n) {
        ...
        for (let e in r)
            if (!br(t.validRange, r[e].range)) return !1;
        return xs({
            eventDrag: e
        }, n)
    }
    ...
    class eo extends Xr {
        render() {
            let {
                ...
                ui: i
            } = r.eventRange, s = Ai(r, n.eventTimeFormat || e.defaultTimeFormat, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
    ...
    function oo(e) {
        let {
            ...
            dateProfile: r,
            isMonthStart: i
        } = e, s = Sr(t, e.todayRange, null, r), o = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : ro) : "";
        ...
        render() {
            ...
            return p(qr.Consumer, null, n => {
                let {
                    ...
                    moreCnt: a
                } = e, l = vo(e), c = "function" == typeof o ? o.call(s, a) : `+${a} ${o}`, d = ot(i.moreLinkHint, [a], c), u = {
                    num: a,
                    shortText: "+" + a,
                    text: c,
                    view: r
    ...
    class Ro {
        ...
        getEventSourceById(e) {
            ...
            e = String(e);
            for (let r in n)
                if (n[r].publicId === e) return new ai(t, n[r]);
            return null
        }
        addEventSource(e) {
            let t = this.getCurrentData();
    ...
    function $o(e, t, n, r) {
        let {
            options: i,
            calendarApi: s
        } = r, o = r.pluginHooks.eventSourceDefs[e.sourceDefId], a = Ye();
        return o.fetch({
            eventSource: e,
            range: t,
            isRefetch: n,
    ...
    class ha {
        ...
        processRawCalendarOptions(e, t) {
            let {
                locales: n,
                locale: r
            } = xn([En, e, t]), i = this.organizeRawLocales(n), s = i.map, o = this.buildLocale(r || i.defaultCode, s).options, a = this.buildPluginHooks(e.plugins || [], ca), l = this.currentCalendarOptionsRefiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, bn), Sn), An), a.listenerRefiners), a.optionRefiners), c = {}, d = xn([En, o, e, t]), u = {}, h = this.currentCalendarOptionsInput, f = this.currentCalendarOptionsRefined, g = !1;
    ...
    class _a extends Zr {
        constructor() {
            super(...arguments), this.buildViewContext = nn(Yr), this.buildViewPropTransformers = nn(ka), this.buildToolbarProps = nn(Ta), this.headerRef = {
                current: null
            }, this.footerRef = {
                current: null
    ...
    class Pa {
        constructor(e) {
            ...
            }, this.containerEl = e, this.emitter = new Hr, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {
                passive: !0
    ...
    class Ba {
        ...
        doRevertAnimation(e, t) {
            ...
            n.style.transition = "top " + t + "ms,left " + t + "ms", He(n, {
                left: r.left,
                top: r.top
            }), Ve(n, () => {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = e => {
                ...
                e && (i = e.context, this.canDropElOnCalendar(n.subjectEl, i) && (s = function (e, t, n) {
                    ...
                    let {
                        refined: i,
                        extra: s
                    } = Zn(r, n), o = $n(i, s, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n), a = e.range.start;
        ...
        componentInteractions: [class extends Gi {
            ...
            constructor(e) {
                super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                    let {
                        component: t
                    } = this, n = gi(this.querySegEl(e)), r = this.eventRange = n.eventRange;
                    ...
                    }), c ? Ze() : Xe(), t || (a && qa(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                }, this.handleDragEnd = e => {
                    let {
                        context: t
                    } = this.component, n = this.eventRange.def, r = this.eventRange.instance, i = new li(t, n, r), s = this.relevantEvents, o = this.mutatedRelevantEvents;
    ...
    class al extends Xr {
        render() {
            let {
                ...
                seg: r
            } = e, i = Ai(r, n.eventTimeFormat || il, t, !0, e.defaultDisplayEventEnd);
            return p(Ks, Object.assign({}, e, {
                elTag: "a",
    ...
    class hl extends Jr {
        ...
        render() {
            ...
            const l = t.showDayNumber && function (e, t, n) {
                ...
                } = t, s = Ht(i, -1), o = n.getYear(r), a = n.getMonth(r), l = n.getYear(s), c = n.getMonth(s);
    ...
    class vl extends Jr {
        ...
        render() {
            let {
                ...
                moreCnts: u,
                moreMarginTops: h
            } = gl(vi(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.eventInstanceHeights, t.maxContentHeight, e.cells), f = e.eventDrag && e.eventDrag.affectedInstances || e.eventResize && e.eventResize.affectedInstances || {};
            return p("tr", {
                ref: this.rootElRef,
                role: "row"
            ...
            if (c)
                for (let f of t) {
                    let {
                        ...
                        instanceId: g
                    } = t.eventRange.instance, m = g + ":" + e, v = f.isVisible && !r[g], y = f.isAbsolute, b = "", E = "";
    ...
    class Al extends Jr {
        constructor() {
            super(...arguments), this.slicer = new Sl, this.tableRef = {
                current: null
            }
        }
        render() {
        ...
        views: {
            dayGrid: {
                component: class extends Cl {
                    constructor() {
                        super(...arguments), this.buildDayTableModel = nn(Rl), this.headerRef = {
                            current: null
                        }, this.tableRef = {
                            current: null
                        }
                    ...
                    render() {
                        let {
                            ...
                            props: n
                        } = this, r = this.buildDayTableModel(n.dateProfile, t), i = e.dayHeaders && p(gs, {
                            ref: this.headerRef,
    ...
    function kl(e) {
        ...
        return p(qr.Consumer, null, n => {
            ...
            let {
                ...
                options: i,
                viewApi: s
            } = n, o = null == i.slotLabelFormat ? Tl : Array.isArray(i.slotLabelFormat) ? yn(i.slotLabelFormat[0]) : yn(i.slotLabelFormat), a = {
                level: 0,
                time: e.time,
    ...
    class Nl extends Jr {
        constructor() {
            super(...arguments), this.allDaySplitter = new _l, this.headerElRef = {
                current: null
            }, this.rootElRef = {
                current: null
            }, this.scrollerElRef = {
                ...
                let {
                    ...
                    dateProfile: r
                } = this.props, i = r.renderRange, s = 1 === jt(i.start, i.end) ? Cr(this.context, i.start, "week") : {};
    ...
    class $l extends Xr {
        ...
        renderPositionedFgSegs(e, t, n, r, i, s) {
            ...
            return p(y, null, this.renderHiddenGroups(E, e), b.map(e => {
                let {
                    seg: o,
                    rect: l
                } = e, c = o.eventRange.instance.instanceId, d = m || Boolean(!t[c] && l), u = Kl(l && l.span), v = !m && l ? this.computeSegHStyle(l) : {
                    left: 0,
                    right: 0
        ...
        renderFillSegs(e, t) {
            let {
                props: n,
                context: r
            } = this, i = Yl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                let s = e[i];
                return p("div", {
                    key: Ci(s.eventRange),
    ...
    class ec extends Xr {
        constructor() {
            super(...arguments), this.splitFgEventSegs = nn(zl), this.splitBgEventSegs = nn(zl), this.splitBusinessHourSegs = nn(zl), this.splitNowIndicatorSegs = nn(zl), this.splitDateSelectionSegs = nn(zl), this.splitEventDrag = nn(Ul), this.splitEventResize = nn(Ul), this.rootElRef = {
                current: null
    ...
    class tc extends Jr {
        constructor() {
            super(...arguments), this.processSlotOptions = nn(nc), this.state = {
                slatCoords: null
            }, this.handleRootEl = e => {
    ...
    class ic extends Jr {
        constructor() {
            super(...arguments), this.buildDayRanges = nn(sc), this.slicer = new rc, this.timeColsRef = {
                current: null
            }
        }
        render() {
        ...
        let s = new Date(0),
            ...
            l = n || function (e) {
                ...
                for (t = oc.length - 1; t >= 0; t -= 1)
                    if (n = ht(oc[t]), r = yt(n, e), null !== r && r > 1) return n;
                return e
            }(r),
            c = [];
        for (; vt(o) < vt(t);) {
    ...
    class dc extends Xr {
        ...
        render() {
            let {
                ...
                textId: a
            } = this.state, l = Sr(s, o), c = n.listDayFormat ? t.format(s, n.listDayFormat) : "", d = n.listDaySideFormat ? t.format(s, n.listDaySideFormat) : "", u = Object.assign({
                date: t.toDate(s),
                view: r,
                textId: a,
                text: c,
    ...
    class bc extends Jr {
        constructor() {
            super(...arguments), this.buildDayTableModel = nn(Rl), this.slicer = new Sl, this.state = {
                labelId: Ue()
            }
        }
        render() {
    ...
    var Rc = Po({
        ...
        views: {
            multiMonth: {
                component: class extends Jr {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = nn(Sc), this.buildMonthFormat = nn(wc), this.scrollElRef = {
                            current: null
                    ...
                    flushScrollReset() {
                        if (this.needsScrollReset && null != this.state.monthHPadding) {
                            const {
                                currentDate: e
                            } = this.props.dateProfile, t = this.scrollElRef.current, n = t.querySelector(`[data-date="${Kt(e)}"]`);
                    ...
                    if (this.isRendering) {
                        ...
                        Fr(() => {
                            U(p(Ji, {
                                ...
                                theme: e.theme,
                                emitter: e.emitter
                            }, (t, n, r, i) => (this.setClassNames(t), this.setHeight(n), p(os.Provider, {
    ...
    }, e.version = "6.1.8", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});
