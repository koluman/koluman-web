            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUsers" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-dashboard-2-line"></i> <span><?php echo app('translator')->get('translation.user'); ?></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarUsers">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="adminusers" class="nav-link"><?php echo app('translator')->get('translation.userlist'); ?></a>
                            </li>
                        </ul>
                    </div>
...
<?php /**PATH C:\Users\mobiloby\master\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>